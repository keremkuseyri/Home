...
if st.session_state["authentication_status"]:
    ...
    dataframe5 = pd.read_excel(f'reports/air_import_employee_kpis/'+ filenames_selected )
    ...
    dataframe2 = pd.read_excel('reports/air_import_employee_kpis/'+ filenames_selected)

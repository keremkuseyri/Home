...
if st.session_state["authentication_status"]:
    ...
    collection_import = db["import_project"]
    collection_export = db["export_project"]
    ...
    if st.session_state["name"] == "Kerem Kuseyri" or st.session_state["name"] == "Üveys Aydemir" or st.session_state["name"] == "Kubilay Cebeci" or st.session_state["name"] == "Senem Çelik" or st.session_state["name"] == "Project Report" or st.session_state["name"] == "Turgut Erkeskin" or st.session_state["name"] == "Özkan Sakar":

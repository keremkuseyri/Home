...
if st.session_state["authentication_status"]:
    ...
    collection_import = db["import_satis_genel_format"]
    collection_export = db["export_satis_genel_format"]
    ...
    if st.session_state["name"] == "Kerem Kuseyri" or st.session_state["name"] == "Üveys Aydemir" or st.session_state["name"] == "Kubilay Cebeci" or st.session_state["name"] == "Senem Çelik" or st.session_state["name"] == "Project Report" or st.session_state["name"] == "Turgut Erkeskin":

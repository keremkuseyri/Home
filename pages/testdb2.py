...
import_styled_df = style_dataframe(import_combined_df)  # Transpose the Import DataFrame
export_styled_df = style_dataframe(export_combined_df)  # Transpose the Export DataFrame

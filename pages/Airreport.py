...
if st.session_state["authentication_status"]:
    ...
    collection_import = db["import_air"]
    collection_export = db["export_air"]
    ...
    if st.session_state["name"] == "Kerem Kuseyri" or st.session_state["name"] == "Üveys Aydemir" or st.session_state["name"] == "Kubilay Cebeci" or st.session_state["name"] == "Senem Çelik" or st.session_state["name"] == "Air Report" or st.session_state["name"] == "Turgut Erkeskin" or st.session_state["name"] == "Özkan Sakar":

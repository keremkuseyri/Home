...
if st.session_state["authentication_status"]:
    ...
    collection_import = db["import_aerospace"]
    collection_export = db["export_aerospace"]
    ...
    if st.session_state["name"] == "Kerem Kuseyri" or st.session_state["name"] == "Üveys Aydemir" or st.session_state["name"] == "Kubilay Cebeci" or st.session_state["name"] == "Senem Çelik" or st.session_state["name"] == "Aerospace Report" or st.session_state["name"] == "Turgut Erkeskin" or st.session_state["name"] == "Özkan Sakar":
